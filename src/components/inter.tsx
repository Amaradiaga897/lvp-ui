...
const Interventor: React.FC = () => (
   <div>
        ...
        <Subheader title="Bienvenido Interventor"/>
       ...
       <div>
        ...
        <div className="container ">
            <div className="content-center">
               ...
               <div>
                <div>
                    <ul className="container pt-1 tamaño3">
                        <table className="font-weight-bold">
                            <tbody>
                              <tr>
                                ...
                                <td>
                                    <Link className="nav-link text-color" to="/inter/id_inter" id="inicio">Perfil</Link>
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                    <Link className="nav-link text-color" to="/inter/id_inter/beneficiarios" id="inicio">Beneficiarios</Link>
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                    <Link className="nav-link text-color" to="/inter/id_inter/beneficiario" id="inicio">Nuevo Beneficiario</Link>
                                </td>
                              </tr>

                              <tr>
                                <th>
                                    <svg className="bi bi-award-fill icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8 0l1.669.864 1.858.282.842 1.68 1.337 1.32L13.4 6l.306 1.854-1.337 1.32-.842 1.68-1.858.282L8 12l-1.669-.864-1.858-.282-.842-1.68-1.337-1.32L2.6 6l-.306-1.854 1.337-1.32.842-1.68L6.331.864 8 0z"/>
                                        <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1 4 11.794z"/>
                                    </svg>
                                </th>
                                <td>
                                    <Link className="nav-link text-color" to="/inter/id_inter/seguimientos" id="inicio">Seguimientos</Link>
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                    <Link className="nav-link text-color" to="/inter/id_inter/seguimiento" id="inicio">Nuevo Seguimiento</Link>
                                </td>
                              </tr>
